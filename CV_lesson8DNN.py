...
# face_net = cv2.dnn.readNetFromCaffe('Data/DNN/deploy.prototxt', 'Data/DNN/res10_300x100.blob')
...
while True:
    ...
    (h, w) = frame.shape[:2] #масштабування координат обличчя

    blob = cv2.dnn.blobFromImage(frame, 1.0, (300, 300), (104.0, 177.0, 123.0)) #багатовимірний массив
